...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
      var getID = document.getElementsByClassName("randomPizzaContainer");
      var dx = determineDx(getID[0], size);
      var newwidth = (getID[0].offsetWidth + dx) + 'px';
    for (var i = 0; i < getID.length; i++) {
      
      getID[i].style.width = newwidth;
    }
  }
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  var numimg = ((screen.height) / s)*cols;  
